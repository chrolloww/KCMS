            ...
            <div class="div_deg">
              <table class="table_deg">
                ...
                <tr>
                  ...
                  @else
                  <td class="image_cell"><img class="collab_image" src="/collabimages/default-image.jpg" alt=""></td>
                  @endif
                  ...
                  <td class="button_cell"><a class="btn btn-secondary" href="{{url('add_activities_page', $data->id)}}">Details</a></td>
                </tr>
