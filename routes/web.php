...
Route::get('/add_activities_page/{id}', 'App\Http\Controllers\JoinController@add_activities_page')->name('add_activities_page');

Route::get('/add_announcement', 'App\Http\Controllers\AdminController@add_announcement')->name('add_announcement');

Route::post('/publish_announcement', 'App\Http\Controllers\AdminController@publish_announcement')->name('publish_announcement');

Route::get('/view_announcement', 'App\Http\Controllers\AdminController@view_announcement')->name('view_announcement');